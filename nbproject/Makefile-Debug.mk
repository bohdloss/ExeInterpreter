...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/exeinterpreter

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/exeinterpreter: ${OBJECTFILES}
...
${OBJECTDIR}/AllocationException.o: AllocationException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AllocationException.o AllocationException.cpp
...
${OBJECTDIR}/EIException.o: EIException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EIException.o EIException.cpp
...
${OBJECTDIR}/ParseException.o: ParseException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParseException.o ParseException.cpp
